if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.addEventListener('controllerchange', () => {
    ...
    banner.innerHTML =
      ...
      '<button onclick="location.reload()" style="background:#000;color:var(--amber);border:none;border-radius:5px;padding:5px 11px;font-family:var(--mono);font-size:11px;font-weight:700;cursor:pointer;letter-spacing:.05em">RELOAD</button>' +

...
async function swpppBuildDocx(insp,cfg){
  ...
  const BLUE=_bq?_bq.BLUE:'1F3864',LT_BLUE=_bq?_bq.LT_BLUE:'D9E2F3',MID_BLUE=_bq?_bq.MID_BLUE:'2E5496',WHITE=_bq?_bq.HTEXT:'FFFFFF',AMBER=_bq?_bq.HOT:'FFF2CC';   // brand-fallback
